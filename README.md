# Прогнозирование динамики внутренней мотивации студентов и завершения онлайн-курса на основе цифровых следов обучения
...
|:--------------------------------------------------:|
| ![Доля перешедших во внутреннюю мотивацию](assets/converted_bar.png) |

| Средний IMI: межкурсовые различия | Завершённость курса |
|:----------------------:|:------------------:|
| ![Средний IMI: межкурсовые различия](assets/heatmap_imi.png) | ![Завершённость курса: межкурсовые различия](assets/heatmap_completion.png) |
...
Рост регулярности и самоинициативы устойчиво увеличивает вероятность завершения курса.  
Гипотеза подтверждается на когортных и сквозных анализах.
...
|:------------------------------:|
| ![Средний IMI по неделям](assets/imi_week_trends.png) |
...
4. Подтверждена связь регулярности и самоинициативы с успешным завершением курса (ρ ≈ 0.30).
5. IMI демонстрирует когортные различия по возрасту и дизайну курсов.

**Рекомендации по развитию:**

- внедрить GroupKFold и гипертюнинг параметров;
- протестировать байесовскую оптимизацию весов IMI;
- добавить SHAP-графики в автоматический отчёт;
- разработать API-интеграцию с Moodle для реального мониторинга;
- внедрить метрики fairness-аудита по когортам (возраст, курс);
- учесть этические аспекты обработки цифровых следов (прозрачность, информированное согласие).
...
| **5** | Связь IMI и завершения курса. | ![IMI vs Completion](assets/imi_vs_completion_scatter.png) |
| **6** | Важность признаков модели (SHAP summary). | ![SHAP summary](assets/shap_summary.png) |
